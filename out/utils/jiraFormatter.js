...
exports.textToJiraMarkup = exports.sanitizeJiraText = void 0;
/**
 ...
 */
function sanitizeJiraText(text) {
    if (!text) {
        return '';
    }
...
exports.sanitizeJiraText = sanitizeJiraText;
/**
 ...
 */
function textToJiraMarkup(text) {
    if (!text) {
        return '';
    }
...
exports.textToJiraMarkup = textToJiraMarkup;
